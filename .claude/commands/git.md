...
2. **Relis le diff stagé** — avant tout commit, relis attentivement les changements pour t'assurer qu'aucun secret, clé, mot de passe ou donnée sensible n'est inclus (`.env.local`, clés JWT, tokens, clés d'API fournisseurs…). Si tu en trouves, stoppe et avertis l'utilisateur.
